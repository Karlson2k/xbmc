...
CUtf32Utils::charcharMap CUtf32Utils::foldCommonCharsMapFiller(void)
{
  charcharMap m;
...
CUtf32Utils::charcharMap CUtf32Utils::foldSimpleCharsMapFiller(void)
{
  ...
  // source: CaseFolding-6.3.0.txt
  // see ftp://ftp.unicode.org/Public/6.3.0/ucd/CaseFolding.txt
  m.insert(charcharMapElement(0x1E9E, 0x00DF)); // LATIN CAPITAL LETTER SHARP S
  m.insert(charcharMapElement(0x1F88, 0x1F80)); // GREEK CAPITAL LETTER ALPHA WITH PSILI AND PROSGEGRAMMENI
  m.insert(charcharMapElement(0x1F89, 0x1F81)); // GREEK CAPITAL LETTER ALPHA WITH DASIA AND PROSGEGRAMMENI
  m.insert(charcharMapElement(0x1F8A, 0x1F82)); // GREEK CAPITAL LETTER ALPHA WITH PSILI AND VARIA AND PROSGEGRAMMENI
  m.insert(charcharMapElement(0x1F8B, 0x1F83)); // GREEK CAPITAL LETTER ALPHA WITH DASIA AND VARIA AND PROSGEGRAMMENI
  m.insert(charcharMapElement(0x1F8C, 0x1F84)); // GREEK CAPITAL LETTER ALPHA WITH PSILI AND OXIA AND PROSGEGRAMMENI
  m.insert(charcharMapElement(0x1F8D, 0x1F85)); // GREEK CAPITAL LETTER ALPHA WITH DASIA AND OXIA AND PROSGEGRAMMENI
  m.insert(charcharMapElement(0x1F8E, 0x1F86)); // GREEK CAPITAL LETTER ALPHA WITH PSILI AND PERISPOMENI AND PROSGEGRAMMENI
  m.insert(charcharMapElement(0x1F8F, 0x1F87)); // GREEK CAPITAL LETTER ALPHA WITH DASIA AND PERISPOMENI AND PROSGEGRAMMENI
  m.insert(charcharMapElement(0x1F98, 0x1F90)); // GREEK CAPITAL LETTER ETA WITH PSILI AND PROSGEGRAMMENI
  m.insert(charcharMapElement(0x1F99, 0x1F91)); // GREEK CAPITAL LETTER ETA WITH DASIA AND PROSGEGRAMMENI
  m.insert(charcharMapElement(0x1F9A, 0x1F92)); // GREEK CAPITAL LETTER ETA WITH PSILI AND VARIA AND PROSGEGRAMMENI
  m.insert(charcharMapElement(0x1F9B, 0x1F93)); // GREEK CAPITAL LETTER ETA WITH DASIA AND VARIA AND PROSGEGRAMMENI
  m.insert(charcharMapElement(0x1F9C, 0x1F94)); // GREEK CAPITAL LETTER ETA WITH PSILI AND OXIA AND PROSGEGRAMMENI
  m.insert(charcharMapElement(0x1F9D, 0x1F95)); // GREEK CAPITAL LETTER ETA WITH DASIA AND OXIA AND PROSGEGRAMMENI
  m.insert(charcharMapElement(0x1F9E, 0x1F96)); // GREEK CAPITAL LETTER ETA WITH PSILI AND PERISPOMENI AND PROSGEGRAMMENI
  m.insert(charcharMapElement(0x1F9F, 0x1F97)); // GREEK CAPITAL LETTER ETA WITH DASIA AND PERISPOMENI AND PROSGEGRAMMENI
  m.insert(charcharMapElement(0x1FA8, 0x1FA0)); // GREEK CAPITAL LETTER OMEGA WITH PSILI AND PROSGEGRAMMENI
  m.insert(charcharMapElement(0x1FA9, 0x1FA1)); // GREEK CAPITAL LETTER OMEGA WITH DASIA AND PROSGEGRAMMENI
  m.insert(charcharMapElement(0x1FAA, 0x1FA2)); // GREEK CAPITAL LETTER OMEGA WITH PSILI AND VARIA AND PROSGEGRAMMENI
  m.insert(charcharMapElement(0x1FAB, 0x1FA3)); // GREEK CAPITAL LETTER OMEGA WITH DASIA AND VARIA AND PROSGEGRAMMENI
  m.insert(charcharMapElement(0x1FAC, 0x1FA4)); // GREEK CAPITAL LETTER OMEGA WITH PSILI AND OXIA AND PROSGEGRAMMENI
  m.insert(charcharMapElement(0x1FAD, 0x1FA5)); // GREEK CAPITAL LETTER OMEGA WITH DASIA AND OXIA AND PROSGEGRAMMENI
  m.insert(charcharMapElement(0x1FAE, 0x1FA6)); // GREEK CAPITAL LETTER OMEGA WITH PSILI AND PERISPOMENI AND PROSGEGRAMMENI
  m.insert(charcharMapElement(0x1FAF, 0x1FA7)); // GREEK CAPITAL LETTER OMEGA WITH DASIA AND PERISPOMENI AND PROSGEGRAMMENI
  m.insert(charcharMapElement(0x1FBC, 0x1FB3)); // GREEK CAPITAL LETTER ALPHA WITH PROSGEGRAMMENI
  m.insert(charcharMapElement(0x1FCC, 0x1FC3)); // GREEK CAPITAL LETTER ETA WITH PROSGEGRAMMENI
  m.insert(charcharMapElement(0x1FFC, 0x1FF3)); // GREEK CAPITAL LETTER OMEGA WITH PROSGEGRAMMENI
